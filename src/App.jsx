...
function CompassIntelligencePanel({data,section='presenting'}){
 ...
 return <>
  ...
  <aside className={`clinical-side-panel ${collapsed?'collapsed':''} ${focusMode?'focus-mode':''}`} aria-label="Compass Intelligence Panel">
   {collapsed
    ?<button type="button" className="panel-reopen" onClick={()=>setCollapsed(false)} aria-label="Open Compass Intelligence">
      <span>💡</span><strong>Open Compass</strong>
     </button>
...
function History({data,set,toggle}){const p=data.psychiatricHistory,f=data.familyHistory;const familyPatterns=Array.isArray(f.relationshipPatterns)?f.relationshipPatterns:(f.relationshipPattern?[f.relationshipPattern]:[]);return <Page><div className="workspace-grid"><div>
 ...
 </div><CompassIntelligencePanel data={data} section="history"/></div></Page>}
...
function Diagnosis({data,set,dispatch}){
 ...
 </div><CompassIntelligencePanel data={data} section="diagnosis"/></div></Page>
}
...
function Documentation({data,outputs,copy,dispatch}){
 ...
 </div><CompassIntelligencePanel data={data} section="documentation"/></div></Page>
}
